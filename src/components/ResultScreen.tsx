      ...
      <section className="w-full max-w-xl rounded-[32px] border border-white/70 bg-white/90 p-5 shadow-[0_24px_80px_rgba(255,143,177,0.2)] backdrop-blur sm:p-6">
        <div className="text-center">
          <p className="inline-flex rounded-full bg-[var(--color-soft-yellow)] px-4 py-2 text-sm font-semibold text-[var(--color-text-secondary)]">
            {isRetryMode ? "다시 풀기 완료" : "오늘의 결과"}
          </p>
          <h1 className="mt-4 text-2xl font-extrabold text-[var(--color-text-primary)] sm:text-3xl">
            {resultMessage}
          </h1>
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3">
          ...
          <div className="col-span-2 rounded-[24px] bg-[var(--color-soft-lavender)] p-4 text-center sm:col-span-1">
            ...
            <p className="mt-2 text-2xl font-extrabold text-[var(--color-text-primary)]">{accuracy}%</p>
          </div>
        </div>
